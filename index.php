...
<html>
  <head>
    <meta charset="UTF-8">
    <title>TUNUVE OPEN API - <?php echo str_replace('_','',$spec);?></title>
  	
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
	
	<link rel="icon" type="image/ico" href="//tunuve.com/tunuve/favicon.png"/>
  ...
  <body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
	  <a class="navbar-brand" href="#">
	  	<img id="img_tunuve" src="https://tunuve.com/tunuve/img/tunuve_invertido.png" alt="Tunuve">
	  </a>
	...
	<?php if( $spec == '' ){ ?>
		...
		<div class="container inicio">
			<div class="col-lg-12">
				...
				<h2>Tunuve Open API</h2>
				<p>Por favor, seleccione la API con la que desea trabajar:</p>
